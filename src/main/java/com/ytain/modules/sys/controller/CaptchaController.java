...
import com.ytain.common.vo.Captcha;
import com.ytain.common.vo.Result;
import com.ytain.util.DrawVerifyCode;
...
public class CaptchaController {
    ...
    public Result<Object> initCaptcha() {
        ...
        String code = new DrawVerifyCode().randomStr(4);
    ...
    public void drawCaptcha(@PathVariable("captchaId") String captchaId, HttpServletResponse response) throws IOException {
        ...
        DrawVerifyCode vCode = new DrawVerifyCode(116,36,4,10,code);
