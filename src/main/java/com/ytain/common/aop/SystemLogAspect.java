...
import com.ytain.util.IpInfoUtil;
import com.ytain.util.ObjectUtil;
import com.ytain.util.ThreadPoolUtil;
 ...
 * @Author: 胡国栋
 * @Description:
 * @Date:Create：in 2019/3/23 22:35
 * @Modified By：
 */
@Aspect
@Slf4j
...
public class SystemLogAspect {
     ...
     * Controller层切点,注解方式
     */
    @Pointcut("@annotation(com.ytain.common.annotation.SystemLog)")
