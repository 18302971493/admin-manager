 ...
 * @Author: 胡国栋
 * @Description:
 * @Date:Create：in 2019/3/23 22:10
 * @Modified By：
 */
@Slf4j
public class JWTFilterSecurity extends BasicAuthenticationFilter {
    ...
    public JWTFilterSecurity(AuthenticationManager authenticationManager, Boolean tokenRedis, Integer tokenExpireTime, StringRedisTemplate redisTemplate) {
    ...
    public JWTFilterSecurity(AuthenticationManager authenticationManager, AuthenticationEntryPoint authenticationEntryPoint) {
